...
const WAKE_OPEN_FRONT_FACE_MAX_DEG = 52;
const WAKE_OPEN_BACK_FACE_MAX_DEG = 45;
const WAKE_OPEN_YAW_ABS_MAX_DEG = 45;
const WAKE_OPEN_FINGER_PLANE_MAX = 0.42;
const WAKE_OPEN_BACK_FINGER_PLANE_MAX = 0.82;
const WAKE_OPEN_STRONG_FACE_FINGER_PLANE_MAX = 0.58;
const WAKE_OPEN_STRONG_FACE_MAX_DEG = 28;
