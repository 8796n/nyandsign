...
function formatOkDebugDisplay(debug, stableGesture) {
    ...
    return [
        ...
        `wakeOpen=${formatOkDebugBool(wake.eligible)} face=${formatOkDebugNumber(wake.faceOnScore)}/${formatOkDebugNumber(wake.faceOnMin)} spread=${formatOkDebugNumber(wake.palmSpreadRatio)}/${formatOkDebugNumber(wake.palmSpreadMin)} fan=${formatOkDebugNumber(wake.fingerFan)} pinkyOpen=${formatOkDebugBool(wake.pinkyOpen)}`,
